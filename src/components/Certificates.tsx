        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {certificates.map((cert, index) => (
              <Card key={index} className="card-gradient shadow-elegant p-4 sm:p-6 hover:shadow-glow transition-smooth group">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="p-2 sm:p-3 bg-primary/10 rounded-full group-hover:bg-primary/20 transition-smooth">
